...
class CompanyAuthControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_login(int $expectedCode, string $userClassFactory): void
    {
        ...
        $response = $this->postJson('/api/auth/company/login', ['email' => $user->email, 'password' => 'password']);
    ...
    public function test_refresh(int $expectedCode, string $userClassFactory): void
    {
        ...
        $response = $this->postJson('/api/auth/company/refresh', ['token' => $tokenPair->refresh->token]);
    ...
    public function test_logout(int $expectedCode, string $userClassFactory): void
    {
        ...
        $response = $this->postJson('/api/auth/company/logout', [], ['Authorization' => 'Bearer ' . $tokenPair->access->token]);
    ...
    public function test_logout_from_all_devices(int $expectedCode, string $userClassFactory): void
    {
        ...
        $response = $this->postJson('/api/auth/company/logout/all', [], ['Authorization' => 'Bearer ' . $tokenPair->access->token]);
    ...
    public function test_profile(int $expectedCode, string $userClassFactory): void
    {
        ...
        $response = $this->getJson('/api/auth/company/profile', ['Authorization' => 'Bearer ' . $tokenPair->access->token]);
